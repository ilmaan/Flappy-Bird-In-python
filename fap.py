...
def score_display(game_state):
    if game_state == 'current_game':
        score_surface = game_font.render(str(int(score)),True,(200,200,200))
    ...
    if game_state == 'game_over':
        ...
        high_score_surface = game_font.render(f'High Score:{int(high_score)}',True,(200,200,200))
        high_score_rect = high_score_surface.get_rect(center = (110,425))
...
pipe_height = [200,360,250,220,300,400]

game_over_surface = pygame.image.load('assets/gameover.png')
game_over_rect = game_over_surface.get_rect(center = (114,256))
